 ...
 * generated in the com.ote.models.enidoc.enids package. 
...
public class FirmaFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ote.models.enidoc.enids
     * 
     */
    public FirmaFactory() {
    }
     ...
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link Firmas }{@code >}
     */
    @XmlElementDecl(namespace = "http://administracionelectronica.gob.es/ENI/XSD/v1.0/firma", name = "firmas")
    public JAXBElement<Firmas> createFirmasXML(Firmas value) {
